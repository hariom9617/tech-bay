        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-xl">
              {items.map((item) => {
                ...
                return (
                  <div
                    key={item.product_id}
                    className="flex flex-col sm:flex-row gap-4 px-4 py-5 justify-between items-start border-b border-gray-200"
                  >
                    ...
                    <div className="flex items-center justify-between w-full sm:w-auto sm:gap-6 mt-2 sm:mt-0">
                      <div className="flex items-center gap-2 text-text-primary">
                        <button
                          className="text-lg font-medium flex h-8 w-8 items-center justify-center rounded-full bg-gray-200 hover:bg-gray-300"
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-xl p-6 sticky top-24">
              <h2 className="text-xl font-bold text-text-primary border-b border-gray-200 pb-4 mb-4">
                Order Summary
              </h2>
